// food_classes.dart
// ─────────────────
// The 256 food class names for the YOLO model (best_ep12.onnx).
// Index must match exactly the training order in UEC Food-256.
//
// NOTE: When the merged model (336 classes) is ready, this list
// will be updated to include the additional Food-101 classes.
...
class FoodClasses {
  static const List<String> names = [
    ...
    'shrimp with chill source', 'roast chicken',
    'steamed meat dumpling', 'omelet with fried rice',
    ...
    'dak galbi', 'dry curry', 'kamameshi', 'rice vermicelli',
    'paella', 'tanmen', 'kushikatu', 'yellow curry', 'pancake',
    'champon', 'crape', 'tiramisu', 'waffle', 'rare cheese cake',
    'shortcake', 'chop suey', 'twice cooked pork',
    'mushroom risotto', 'samul', 'zoni', 'french toast',
    'fine white noodles', 'minestrone', 'pot au feu',
    'chicken nugget', 'namero', 'french bread', 'rice gruel',
    'broiled eel bowl', 'clear soup', 'yudofu', 'mozuku',
    ...
    'Barbecued red pork in sauce with rice', 'Rice with roast duck',
    'Rice crispy pork', 'Wonton soup',
    'Chicken Rice Curry With Coconut', 'Crispy Noodles',
    'Egg Noodle In Chicken Yellow Curry', 'coconut milk soup',
    'pho', 'Hue beef rice vermicelli soup',
    'Vermicelli noodles with snails', 'Fried spring rolls',
    'Steamed rice roll', 'Shrimp patties',
    ...
    'oxtail soup', 'adobo', 'lumpia', 'brownie', 'churro',
    'jambalaya', 'nasi goreng', 'ayam goreng', 'ayam bakar',
    'bubur ayam', 'gulai', 'laksa', 'mie ayam', 'mie goreng',
    'nasi campur', 'nasi padang', 'nasi uduk', 'babi guling',
    'kaya toast', 'bak kut teh', 'curry puff', 'chow mein',
    'zha jiang mian', 'kung pao chicken', 'crullers',
    'eggplant with garlic sauce', 'three cup chicken',
    'bean curd family style',
    'salt and pepper fried shrimp with shell', 'baked salmon',
    'braised pork meat ball with napa cabbage', 'winter melon soup',
    'steamed spareribs', 'chinese pumpkin pie',
    'eight treasure rice', 'hot and sour soup',
  ];
